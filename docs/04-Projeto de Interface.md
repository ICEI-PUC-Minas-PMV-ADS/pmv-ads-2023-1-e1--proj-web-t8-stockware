...
![Exemplo de UserFlow](img/Fluxo-administrador.png) Figura 02 - Fluxo do Administrador 
...
![Exemplo de Wireframe](img/Wireframe.png)  Figura 03 - Wireframes
...
![Exemplo de Wireframe](img/Login.png) Figura 04 - Tela – Login (perfil usuário e administrador)
...
![Exemplo de Wireframe](img/Lista-de-materiais-1.png) Figura 05 - ela – Lista de materiais (perfil usuário)
...
![Exemplo de Wireframe](img/Lista-de-materiais-2.png) Figura 06 - ela – Lista de materiais (perfil Admin)
...
![Exemplo de Wireframe](img/Filtros.png) Figura 07 - Tela – Filtros (perfil usuário e administrador)
...
![Exemplo de Wireframe](img/Carrinho.png) Figura 08 - Tela - Carrinho (perfil usuário e administrador)
...
![Exemplo de Wireframe](img/Solicitação-de-reserva.png) Figura 09 - Tela - Número de solicitação de reserva (perfil usuário e administrador)
...
![Exemplo de Wireframe](img/Principal-usurio.png) Figura 10 - Tela principal (perfil usuário) 
![Exemplo de Wireframe](img/Principal-ADM.png) Figura 11- Tela principal (perfil administrador) 
...
![Exemplo de Wireframe](img/Devolução.png) Figura 12 - Tela - Devolução (perfil usuário e administrador) 
...
![Exemplo de Wireframe](img/Imprimir-devolução.png) Figura 13 - Tela - Solicitação de devolução (perfil usuário e administrador) 
...
![Exemplo de Wireframe](img/Favoritos.png) Figura 14 - Tela - Favoritos (perfil usuário e administrador) 
...
![Exemplo de Wireframe](img/consultar-reserva-usuario.png) Figura 15 - Tela – Consultar reserva (perfil usuário) 

##   Tela principal - (perfil administrador) 

Pela tela principal o administrador ou usuário, pode fazer logout (sair da conta)

![Exemplo de Wireframe](img/Sair-da-conta.png) Figura 16 - Tela principal - (perfil administrador) 
...
![Exemplo de Wireframe](img/Resumo-notificação.png) Figura 17 - Tela principal - (perfil administrador) 
...
![Exemplo de Wireframe](img/Lista-de-materiais-ADM.png) Figura 18 - Tela – Lista de materiais (perfil administrador)
...
![Exemplo de Wireframe](img/cadastrar-materiais.png) Figura 19 - Tela – Cadastrar materiais (perfil administrador) 
...
![Exemplo de Wireframe](img/Editar-material.png) Figura 20 - Tela – Editar material (perfil administrador) 
...
![Exemplo de Wireframe](img/Histórico.png) Figura 21 - Tela – Histórico de produtos (perfil administrador) 
...
![Exemplo de Wireframe](img/Cor.png) Figura 22 - Tela - Editar temas (perfil administrador e usuário) 
...
![Exemplo de Wireframe](img/editar-layout.png) Figura 23 - Tela - Editar layout - (perfil administrador e usuário) 
...
![Exemplo de Wireframe](img/Gerenciar-reserva.png) Figura 24 - Tela – Gerenciamento de reserva (perfil administrador) 
...
![Exemplo de Wireframe](img/cadastrar-usuário.png) Figura 25 - Tela – Cadastrar usuário (perfil administrador)
